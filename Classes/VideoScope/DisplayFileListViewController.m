...
-(void)editDoneButonAction:(id)sender{
    ...
    if (isEditing) {
        ...
        shareBtn.enabled = NO;
        self.navigationItem.rightBarButtonItems = @[doneButton,selectDeselectBtn,shareBtn,deleteBtn];
        isEditing=YES;
...
-(void)shareButtonAction:(id)sender{
    ...
    NSLog(@"Pic Path Array is %@",arrayTodelete);
    NSMutableArray *sharingItems = [NSMutableArray new];
    
    if (isP2P) {
        
        for (NSString*strAddress in arrayTodelete) {
            ...
            strPath = [strPath stringByAppendingPathComponent:strAddress];
            //[sharingItems addObject:strAddress];
            ...
            {
                UIImage *image = [UIImage imageWithData:[NSData dataWithContentsOfFile:strPath]];
    ...
    else  // IP Camera
    {
        ...
        for (NSString*strAddress in arrayTodelete) {
            ...
            NSString *savedImagePath = [dataPath stringByAppendingPathComponent:strAddress];
            ...
            if ([filePathExtenstion caseInsensitiveCompare:@"jpg"] == NSOrderedSame || [filePathExtenstion caseInsensitiveCompare:@"jpeg"] == NSOrderedSame|| [filePathExtenstion caseInsensitiveCompare:@"png"] == NSOrderedSame ||[filePathExtenstion caseInsensitiveCompare:@"gif"] == NSOrderedSame)
            {
                ...
                UIImage *image = [UIImage imageWithData:[NSData dataWithContentsOfFile:savedImagePath]];
                [sharingItems addObject:image];
